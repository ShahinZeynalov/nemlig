...
class NemligScraper():
    ...
    def nemlig_list(self):
        ...
        with open('example.txt', 'r') as file:
            ...
            for i, url in enumerate(urls):
                ...
                self.browser.save_screenshot('first.png')
                if click:
                ...
                try:
                    ...
                    # ActionChains(self.browser).move_to_element(self.browser.find_element_class_name('product-detail__description-text')).perform()
    ...
    def scrape_urls(self):
        with open('sublink.txt', 'r') as file:
